...
class TemperatureWidget extends StatelessWidget {
  TemperatureWidget({Key? key, required this.temperature}) : super(key: key);
            ...
            children: [
              ...
              StreamBuilder(
                ...
                builder: (context,
                  ...
                  List<TempData> tempDataList = snapshot.data!.docs.map((e) {
                    return TempData(
                      domain: e.data()['timevalue'].toDouble(),
                      measure: e.data()['temp'].toDouble(), //ganti
                    );
                  }).toList();

                  // Sort the list in descending order based on the 'domain' (timevalue)

                  tempDataList.sort((a, b) => b.domain.compareTo(a.domain));

                  // Take the first 5 data points with the greatest 'timevalue'
                  List<TempData> topFiveData =
                      tempDataList.take(5).toList(); //ganti
              ...
              StreamBuilder(
                ...
                builder: (context,
                  ...
                  // Take the first 5 data points with the greatest 'timevalue'
                  List<TempData> topFiveData = tempDataList.take(5).toList();
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  Text('Temp', style: styleTitle), //ganti
                                  SizedBox(height: 17),
                                  Text(
