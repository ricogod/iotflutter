...
class HumidityWidget extends StatelessWidget {
  HumidityWidget({Key? key, required this.humidity}) : super(key: key);
  final int humidity;
            ...
            children: [
              ...
              StreamBuilder(
                ...
                builder: (context,
                  ...
                  List<HumData> HumDataList = snapshot.data!.docs.map((e) {
                    return HumData(
                      domain: e.data()['timevalue'].toDouble(),
                      measure: e.data()['hum'].toDouble(), //ganti
                    );
                  }).toList();

                  // Sort the list in descending order based on the 'domain' (timevalue)

                  HumDataList.sort((a, b) => b.domain.compareTo(a.domain)); //ganti

                  // Take the first 5 data points with the greatest 'timevalue'
                  List<HumData> topFiveData =
                      HumDataList.take(5).toList(); //ganti
              ...
              StreamBuilder(
                ...
                builder: (context,
                  ...
                  HumDataList.sort((a, b) => b.domain.compareTo(a.domain));

                  // Take the first 5 data points with the greatest 'timevalue'
                  List<HumData> topFiveData = HumDataList.take(5).toList();
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  Text('Hum', style: styleTitle), //ganti
                                  SizedBox(height: 17),
                                  Text(
